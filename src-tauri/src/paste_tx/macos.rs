...
define_class!(
    ...
    #[name = "AppPasteProvider"]
    #[ivars = ProviderIvars]
    pub struct AppPasteProvider;

    impl AppPasteProvider {
...
struct MacPending {
    ...
    provider: Option<Retained<AppPasteProvider>>,
    auto_submit: bool,
...
pub(super) fn run(
    ...
    let provider = AppPasteProvider::new(state.clone(), text.to_string());
