//! Model capability probing — the seam between NeverType's model UI and "what can
...
/// How confident we are that NeverType can run a given model, judged from its GGUF
