...
/// Where a model comes from and how NeverType obtains it — the routing discriminant
...
/// Bridges hf-hub's async download progress to NeverType's `model-download-progress`
...
impl ModelManager {
    ...
    /// models dropped in or downloaded outside NeverType show up without a restart.
    ...
    /// shared Hugging Face cache, so models downloaded by NeverType (or any other
