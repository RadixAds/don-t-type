...
/// Resolve how confidently NeverType knows the language of the text produced by a
...
fn resolve_output_language_evidence(
    ...
    // V3) always auto-detect and ignore NeverType's selection; transcribe-cpp also
...
/// Map NeverType's whisper accelerator setting to a transcribe-cpp [`Backend`].
///
